...
public class SpanishProcessingController extends GenericProcessing {
    ...
    private static final Timer.Builder timer = Timer.builder("spanish_requests_latency_seconds")
    ...
    @Autowired
    public SpanishProcessingController(Publisher<Long, String> publisher,
