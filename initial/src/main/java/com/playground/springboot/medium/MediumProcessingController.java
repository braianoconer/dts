...
@RestController
public class MediumProcessingController extends GenericProcessing {

    private static final long MAX_DELAY_MILLIS = 3000;

    private static final String LABEL = "MEDIUM";

    private static final Timer.Builder timer = Timer.builder("medium_requests_latency_seconds")
    ...
    @Autowired
    public MediumProcessingController(GenericKafkaPublisher kafkaPublisher, GenericKafkaConsumer kafkaConsumer, MeterRegistry registry) {
